...
$result = mysqli_query($conn,"SELECT Remote_Station_ID,Date,Time,3Mhz_data from hf_noise_data ORDER BY Date desc ,Time  desc LIMIT 20000;");
...
echo "writing file";
//echo "<br>".$data_set;
#$file = "/home/anton/html/hf_noise/dygraphs/data_3mhz.php";
