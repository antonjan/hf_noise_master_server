...
$result2 = mysqli_query($conn,"SELECT DISTINCT Remote_Station_ID FROM hf_noise_data;");
$data_set = "";
$station_IDs= array();
...
$result = mysqli_query($conn,"SELECT Remote_Station_ID,Date,Time,1Mhz_data from hf_noise_data ORDER BY Date desc ,Time  desc LIMIT 29000;");
...
echo "writing file";
//echo "<br>".$data_set;
///var/www/html/rfnoise/hf_noise/
$file = "/var/www/html/rfnoise/hf_noise/dygraphs/data_1mhz.php";
